...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'whatsapp_number'       => 'رقم الجوال (واتساب)',
        'other_number'          => 'رقم شخص آخر',
        'job'                   => 'الوظيفة',
        'social_status'         => 'الحالة الإجتماعية',
        'family_number'         => 'عدد أفراد العائلة',
        'who_spend'             => 'من يتولى الإنفاق على العائلة',
        'iban'                  => ' رقم الأيبان',
        'iban_confir'           => ' تأكيد رقم الأيبان',
        'bank_name'             => ' اسم البنك',
        ...
        'checkvalue'            => ' الإقرار',
        'place'                 => 'مكان السكن',
        'description'           => ' وصف مكان السكن',
        'location_N'            => 'احداثيات السكن (N)',
        'location_E'            => 'احداثيات السكن (E)',
        'building_ownership'    => 'ملكية السكن',
        'building_type'         => 'نوع السكن',
